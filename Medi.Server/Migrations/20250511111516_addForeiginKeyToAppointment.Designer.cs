...
namespace Medi.Server.Migrations
{
    ...
    [Migration("20250511111516_addForeiginKeyToAppointment")]
    partial class addForeiginKeyToAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medi.Server.Models.Enities.AppointmentSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Medi.Server.Models.Enities.WorkingHours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Medi.Server.Models.Enities.Appointment", b =>
                {
                    b.HasOne("Medi.Server.Models.Enities.AppointmentSlot", "AppointmentSlot")
                        .WithOne("Appointment")
                        .HasForeignKey("Medi.Server.Models.Enities.Appointment", "AppointmentSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Medi.Server.Models.Enities.WorkingHours", b =>
                {
                    b.HasOne("Medi.Server.Models.Enities.Doctor", null)
